      ...
      <Card className="bg-green-600 border-green-500 text-white">
        ...
        <CardContent className="space-y-4">
          <section className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            {canCall && (
              <Button
                ...
                disabled={isLoading}
                variant="default"
                className="bg-yellow-600 hover:bg-yellow-700 font-bold cursor-pointer"
              >
                Call ${callAmount}
              </Button>
            )}
            ...
            <Button
              ...
              variant="outline"
              className="bg-purple-600 hover:bg-purple-700 border-purple-500 text-white hover:text-white font-bold cursor-pointer"
            >
          ...
          <section className="space-y-3">
            {maxBet === 0 && (
              <form className="flex items-center space-x-3" onSubmit={e => { e.preventDefault(); handleBet(); }}>
                <Input
                  type="number"
                  value={betAmount}
            ...
            {maxBet > 0 && (
              <form className="flex items-center space-x-3" onSubmit={e => { e.preventDefault(); handleRaise(); }}>
                <Input
                  type="number"
                  value={raiseAmount}
          ...
          <aside className="text-sm text-green-200">
